...
func (m mockRepository) Get(ctx context.Context, id string) (entity.Advert, error) {
...
func (m mockRepository) Query(ctx context.Context, offset, limit int) ([]entity.Advert, error) {
	return m.items, nil
}

func (m *mockRepository) Create(ctx context.Context, album entity.Advert) error {
	if album.Name == "error" {
		return errCRUD
	}
...
func (m *mockRepository) Update(ctx context.Context, album entity.Advert) error {
	if album.Name == "error" {
		return errCRUD
	}
